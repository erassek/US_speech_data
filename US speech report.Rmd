...
In this section we are going to use ROCR library. 

First we calculate the predictions on the validation_set:
...
```
Now we calculate the KS statistic. We take the max delt between cumulative bad and good rates. 
